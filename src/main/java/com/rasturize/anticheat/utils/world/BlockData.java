...
import com.rasturize.anticheat.utils.world.blocks.*;
import com.rasturize.anticheat.utils.world.types.*;
...
public enum BlockData {
    ...
    _SNOW((protocol, b) -> {
        ...
        return new SimpleCollisionBox(0, 0, 0, 1, height * Utils.EIGHTH, 1);
    }, Material.SNOW),
    ...
    _CHEST(new SimpleCollisionBox(0, 0, 0, 1, 1 - Utils.EIGHTH, 1).expand(-Utils.EIGHTH, 0, -Utils.EIGHTH),
            CHEST, TRAPPED_CHEST, ENDER_CHEST),
    _ETABLE(new SimpleCollisionBox(0, 0, 0, 1, 1 - Utils.FOURTH, 1),
            ENCHANTMENT_TABLE),
    _FRAME(new SimpleCollisionBox(0, 0, 0, 1, 1 - (Utils.SIXTEENTH * 3), 1),
            ENDER_PORTAL_FRAME),
