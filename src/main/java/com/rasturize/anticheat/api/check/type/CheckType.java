...
package com.rasturize.anticheat.api.check.type;

import com.rasturize.anticheat.utils.DynamicInit;
...
public @interface CheckType {
    ...
    class Dynamic {
        public static Set<Class<?>> get() throws Throwable {
           return DynamicInit.getClasses("com.rasturize", CheckType.class);
        }
    }
}
