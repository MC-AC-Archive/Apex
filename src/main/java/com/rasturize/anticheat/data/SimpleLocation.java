...
public class SimpleLocation {
    ...
    public SimpleLocation(PlayerData playerData) {
        this.x = playerData.movement.tx;
        this.y = playerData.movement.ty;
        this.z = playerData.movement.tz;

        this.yaw = playerData.movement.tyaw;
        this.pitch = playerData.movement.tpitch;
    }
